...
interface ScreenTimeModuleInterface {
  ...
  getScreenEvents: (startTimeMs: number, endTimeMs: number) => Promise<ScreenEventsResult>;
  getAppUsageStats: (startTimeMs: number, endTimeMs: number) => Promise<AppUsageStatsResult>;
  estimateSleepWindow: (startTimeMs: number, endTimeMs: number) => Promise<SleepWindowResult>;
  getScreenTimeSummary: (startTimeMs: number, endTimeMs: number) => Promise<ScreenTimeSummary>;
}
